...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://goo.gl/rKJWvA' target='_blank'><iframe scrolling='no' src='http://your-house.vn/sacom.html' width='100%' height='250' frameborder='0'></iframe><br/>Bán Căn Hộ HQC Bình Trưng Đông</a>. Liên Hệ Chủ Đầu Tư Dự Án. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
